...
<%==SIM:Set:public=Public==%>
		...
		<%==SIM:EndFor==%><%==SIM:Element.Visibility==%> <%==SIM:If:Element.IsLeaf==%>NotInheritable <%==SIM:EndIf==%><%==SIM:If:Element.IsAbstract==%>MustInherit <%==SIM:EndIf==%>Class <%==SIM:Element.Name==%>
